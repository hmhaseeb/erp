    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    <h4 class="mb-sm-0 font-size-18">Bank Book Statement</h4>
                    <p class="text-muted font-size-13 mb-0">Reconciliation and journal records for company banking accounts, cheques, and transfers.</p>
                </div>
    ...
    @if($selectedAccount)
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        <span class="text-muted font-size-12 d-block">Total Bank Deposits (+)</span>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        <span class="text-muted font-size-12 d-block">Total Withdrawals (-)</span>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        <span class="text-muted font-size-12 d-block">Closing Bank Balance</span>
