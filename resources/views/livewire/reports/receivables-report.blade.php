    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    <h4 class="mb-sm-0 font-size-18">Accounts Receivable Aging & Report</h4>
                    <p class="text-muted font-size-13 mb-0">Track outstanding balances due from customers and drill down into unpaid sales invoices.</p>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <span class="text-muted font-size-12 d-block">Total Outstanding Receivables</span>
                            <h3 class="mb-0 text-danger fw-bold font-monospace">AED {{ number_format($totalReceivable, 2) }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <span class="text-muted font-size-12 d-block">Customers with Pending Balances</span>
                            <h3 class="mb-0 text-dark fw-bold">{{ number_format($customersWithBalance) }} Clients</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            <div wire:loading.flex wire:target="search, filter_balance, perPage, sortBy, resetFilters" class="justify-content-center align-items-center py-4 text-primary">
                ...
                <span class="font-size-13">Loading receivables...</span>
            </div>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <h6 class="text-dark">No outstanding receivables found</h6>
                                        <p class="text-muted font-size-13 mb-3">All customers are currently settled with zero outstanding balance.</p>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" wire:click="closeInvoicesModal"></button>
                    </div>
