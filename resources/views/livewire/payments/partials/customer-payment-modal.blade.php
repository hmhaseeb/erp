<x-modal 
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 mb-3">
            <label class="form-label">Total Amount Received ({{ currency() }}) <span class="text-danger">*</span></label>
                    ...
                    <tbody>
                        @foreach($unpaidSales as $sale)
                            <tr>
                                ...
                                <td class="text-end font-monospace text-danger">{{ currency() }} {{ number_format($sale->due_amount, 2) }}</td>
                                <td>
