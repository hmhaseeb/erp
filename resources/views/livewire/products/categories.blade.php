        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="text-muted font-size-13 mb-0">Organize products into classification groups and categories.</p>
                </div>
            ...
            <div wire:loading.remove wire:target="search, perPage, sortBy, resetFilters" class="table-responsive">
                <table class="table align-middle table-hover table-nowrap mb-0 font-size-13">
                    <thead class="table-light">
                        <tr>
                            <th wire:click="sortBy('code')" class="sortable" style="width: 120px;">
                                Code
                                @if($sortField === 'code')
                        ...
                        @forelse($categories as $c)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-soft-primary font-size-12">{{ $c->products_count }} Products</span>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        @if($search)
                                            <h6 class="text-dark">No matching categories found</h6>
                                        ...
                                        @else
                                            <h6 class="text-dark">No product categories created yet</h6>
                                            <p class="text-muted font-size-13 mb-3">Create product categories to organize and filter inventory items.</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $isEditMode ? 'Edit Category' : 'Create Product Category' }}</h5>
