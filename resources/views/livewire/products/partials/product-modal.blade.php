@props([
    ...
    'title' => ($isEditMode ?? false) ? 'Edit Product Item' : 'Register New Product',
...
<x-modal 
    ...
    <div class="row">
        ...
        @endif
        <div class="{{ $isEditMode ? 'col-12 col-sm-8' : 'col-12 col-sm-4' }} mb-3">
            <label class="form-label">Warehouse Location</label>
            <input type="text" wire:model="warehouse" class="form-control" placeholder="e.g. Rack A-12">
        </div>
    </div>
