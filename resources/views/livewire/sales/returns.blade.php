<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    <h4 class="mb-sm-0 font-size-18">Sales Returns / Credit Notes</h4>
                    <p class="text-muted font-size-13 mb-0">Record items returned by customers, restore stock inventory, and issue receivable credits.</p>
                </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            <div wire:loading.flex wire:target="search, customer_id_filter, date_from, date_to, perPage, sortBy, resetFilters" class="justify-content-center align-items-center py-4 text-primary">
                <div class="spinner-border spinner-border-sm me-2" role="status"></div>
                <span class="font-size-13">Loading returns...</span>
            </div>

            <div wire:loading.remove wire:target="search, customer_id_filter, date_from, date_to, perPage, sortBy, resetFilters" class="table-responsive">
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        @if($search || $customer_id_filter || $date_from || $date_to)
                                            <h6 class="text-dark">No sales returns found</h6>
                                            <p class="text-muted font-size-13 mb-3">No credit notes match your search filters.</p>
                                            <button wire:click="resetFilters" class="btn btn-sm btn-light">
                                                <i class="bx bx-reset me-1"></i> Reset Filters
                                            </button>
                                        @else
                                            <h6 class="text-dark">No sales returns processed</h6>
                                            <p class="text-muted font-size-13 mb-3">Record customer returns to restore stock to inventory and credit customer account.</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header">
                        <h5 class="modal-title">Process Sales Return (Credit Note)</h5>
