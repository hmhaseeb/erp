        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="text-muted font-size-13 mb-0">Organize and categorize business operating costs, rent, utilities, and overheads.</p>
                </div>
                <div class="page-title-right">
                    <button wire:click="openModal" class="btn btn-primary waves-effect waves-light">
                        <i class="bx bx-plus me-1"></i> Add Expense Category
                    </button>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        @if($search)
                                            <h6 class="text-dark">No matching expense categories found</h6>
                                        ...
                                        @else
                                            <h6 class="text-dark">No expense categories created yet</h6>
                                            <p class="text-muted font-size-13 mb-3">Create categories like Rent, Electricity, Salaries, Marketing to track business expenses.</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $isEditMode ? 'Edit Expense Category' : 'Create Expense Category' }}</h5>
                    ...
                    <form wire:submit.prevent="saveCategory">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Office Rent, Electricity, Staff Salaries">
