<div>
    <!-- Page Header -->
    <x-page-header title="Expense Categories" subtitle="Organize and categorize business operating costs, rent, utilities, and overheads.">
                    ...
                    <tr>
                        <td colspan="4">
                            <x-empty-state 
                                ...
                                title="No expense categories created yet" 
                                message="Create categories like Rent, Electricity, Salaries, Marketing to track business expenses."
                                :search="$search"
                                addAction="openModal"
    ...
    <!-- Category Modal -->
    @include('livewire.expenses.partials.expense-category-modal')
</div>
